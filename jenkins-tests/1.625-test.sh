...
gatherTestReports(){
	...
	if [ ! -f /home/nisal/Dropbox/TestResults/Jenkins/1.625_ath_reports_"$JenkinsVersion".log ];then
			touch /home/nisal/Dropbox/TestResults/Jenkins/1.625_ath_reports_"$JenkinsVersion".log
	fi
}
