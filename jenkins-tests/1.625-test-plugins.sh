...
NestedViewPluginTest,CompressArtifactsPluginTest,MultipleScmsPluginTest,DashboardViewPluginTest,ProjectDescriptionSetterPluginTest,BatchTaskPluginTest,WsCleanupPluginTest,\
