...
if [ ! -f $REPORTS_DIR/core_1.609_ath_reports_"$JenkinsVersion".log ];then
    	touch $REPORTS_DIR/core_1.609_ath_reports_"$JenkinsVersion".log
fi
...
TYPE=existing BROWSER=seleniumGrid JENKINS_URL=http://134.96.235.47:$startupPort/jenkins$JenkinsVersion/ mvn -Dtest=**/core/*Test test 2>&1 | tee $REPORTS_DIR/core_1.609_ath_reports_"$JenkinsVersion".log
