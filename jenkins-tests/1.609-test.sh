...
gatherTestReports(){
	...
	if [ ! -f /home/nisal/Dropbox/TestResults/Jenkins/1.609_ath_reports_"$JenkinsVersion".log ];then
			touch /home/nisal/Dropbox/TestResults/Jenkins/1.609_ath_reports_"$JenkinsVersion".log
	fi
}
...
TYPE=existing BROWSER=seleniumGrid JENKINS_URL=http://134.96.235.47:$startupPort/jenkins$JenkinsVersion/ mvn test 2>&1 | tee /home/nisal/Dropbox/TestResults/Jenkins/1.609_ath_reports_"$JenkinsVersion".log
}
