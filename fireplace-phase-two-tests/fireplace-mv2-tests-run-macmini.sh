...
tests/desktop/consumer_pages/test_home_page.py::TestConsumerPage::test_that_promo_module_is_visible \
...
tests/desktop/consumer_pages/test_home_page.py::TestConsumerPage::test_opening_every_category_page_from_categories_menu \
