...
chmod 755 $FireplaceBaseDir/phase_two_test_mv1_$FireplaceInstance/dbconftest.py 
cat > $FireplaceBaseDir/phase_two_test_mv1_$FireplaceInstance/dbconftest.py << EOF
...
cd $FireplaceBaseDir/phase_two_test_mv1_$FireplaceInstance
...
tests/desktop/consumer_pages/test_consumers_page.py::TestConsumerPage::test_that_verifies_nav_menu_tabs \
