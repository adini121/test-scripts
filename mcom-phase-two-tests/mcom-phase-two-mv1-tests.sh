...
echo " "
echo "Bedrock dir will be test_mv1_phase2_$BedrockInstance"
if [ -d $BedrockBaseDir/test_mv1_phase2_$BedrockInstance ]; then
	rm -rf $BedrockBaseDir/test_mv1_phase2_$BedrockInstance
fi
git -C $BedrockBaseDir clone -b master --single-branch git@github.com:adini121/mcom-tests.git test_mv1_phase2_$BedrockInstance
git -C $BedrockBaseDir/test_mv1_phase2_$BedrockInstance checkout $CommitHash
git -C $BedrockBaseDir/test_mv1_phase2_$BedrockInstance checkout -b testing-branch
}

checkConftestPresence(){
if [ ! -f $BedrockBaseDir/test_mv1_phase2_$BedrockInstance/conftest.py ];then
    touch $BedrockBaseDir/test_mv1_phase2_$BedrockInstance/conftest.py
    chmod 755 $BedrockBaseDir/test_mv1_phase2_$BedrockInstance/conftest.py
fi
}
gatherTestReports(){
...
if [ ! -f $REPORTS_DIR/Phase2_BedrockTests_mv1_"$BedrockGitTag".log ];then
	touch $REPORTS_DIR/Phase2_BedrockTests_mv1_"$BedrockGitTag".log
fi

if [ ! -f $REPORTS_DIR/Phase2_BedrockBrowserIdList_mv1_"$BedrockGitTag".log ];then
    touch $REPORTS_DIR/Phase2_BedrockBrowserIdList_mv1_"$BedrockGitTag".log
fi
}
...
EOF
echo ">>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>"
touch $BedrockBaseDir/test_mv1_phase2_$BedrockInstance/dbconftest.py
chmod 755 $BedrockBaseDir/test_mv1_phase2_$BedrockInstance/dbconftest.py
cat > $BedrockBaseDir/test_mv1_phase2_$BedrockInstance/dbconftest.py << EOF
...
echo ">>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>"
sleep 2
cat $BedrockBaseDir/test_mv1_phase2_$BedrockInstance/dbconftest.py >> $BedrockBaseDir/test_mv1_phase2_$BedrockInstance/conftest.py
sleep 2
sed -i 's|test_session_ids|sessionids_mv1_'$BedrockGitTag'|g' $BedrockBaseDir/test_mv1_phase2_$BedrockInstance/conftest.py
sed -i 's|/home/nisal/python.txt|'$REPORTS_DIR'/Phase2_BedrockBrowserIdList_mv1_'$BedrockGitTag'.log|g' $BedrockBaseDir/test_mv1_phase2_$BedrockInstance/conftest.py
}

configureVirtualenv(){
cd $BedrockBaseDir/test_mv1_phase2_$BedrockInstance
...
tests/test_about.py::TestAboutPage::test_tabzilla_link_destinations_are_corrects \
...
tests/test_about.py::TestAboutPage::test_sign_up_form_submit_is_successful \
...
tests/test_contribute.py::TestContribute::test_footer_section \
...
tests/test_dnt.py::TestDoNotTrack::test_footer_section \
tests/test_dnt.py::TestDoNotTrack::test_tabzilla_links_are_correct \
tests/test_dnt.py::TestDoNotTrack::test_status_section \
tests/test_mission.py::TestMission::test_major_link_destinations_are_correct \
tests/test_mission.py::TestMission::test_footer_section \
...
tests/test_mozillabased.py::TestMozillaBasedPagePage::test_footer_section_links \
...
tests/test_nightlyfirstrun.py::TestNightlyFirstRun::test_footer_link_destinations_are_correct \
...
tests/test_notes.py::TestNotes::test_that_notes_page_is_reachable \
tests/test_partners.py::TestPartners::test_footer_section \
tests/test_partners.py::TestPartners::test_tabzilla_links_are_correct \
tests/test_partners.py::TestPartners::test_partner_images_pager_two \
...
tests/test_privacy.py::TestPrivacy::test_footer_section \
tests/test_privacy.py::TestPrivacy::test_page_sections \
tests/test_products.py::TestProductsPage::test_footer_section \
tests/test_products.py::TestProductsPage::test_tabzilla_links_are_correct \
tests/test_products.py::TestProductsPage::test_product_nav_link_destinations_are_correct \
tests/test_products.py::TestProductsPage::test_product_nav_link_urls_are_valid \
tests/test_products.py::TestProductsPage::test_image_srcs_are_correct \
tests/test_products.py::TestProductsPage::test_firefox_link_destinations_are_correct \
tests/test_products.py::TestProductsPage::test_firefox_link_urls_are_valid \
tests/test_products.py::TestProductsPage::test_mozilla_link_destinations_are_correct \
tests/test_products.py::TestProductsPage::test_developers_link_destinations_are_correct \
tests/test_products.py::TestProductsPage::test_developers_link_urls_are_valid \
...
tests/test_sms.py::TestSMSPage::test_info_link_urls_are_valid \
tests/test_sms.py::TestSMSPage::test_footer_section \
tests/test_sms.py::TestSMSPage::test_tabzilla_links_are_correct \
2>&1 | tee $REPORTS_DIR/Phase2_BedrockTests_mv1_"$BedrockGitTag".log
}
