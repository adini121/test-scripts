...
tests/desktop/test_homepage.py:1:TestHome::test_that_clicking_top_rated_shows_addons_sorted_by_rating \
tests/desktop/test_homepage.py:1:TestHome::test_that_clicking_most_popular_shows_addons_sorted_by_users \
tests/desktop/test_homepage.py:1:TestHome::test_that_clicking_featured_shows_addons_sorted_by_featured \
tests/desktop/test_homepage.py:1:TestHome::test_header_site_navigation_menus_are_correct \
tests/desktop/test_homepage.py:1:TestHome::test_the_name_of_each_site_navigation_menu_in_the_header \
tests/desktop/test_homepage.py:1:TestHome::test_top_three_items_in_each_site_navigation_menu_are_featured \
tests/desktop/test_homepage.py:1:TestHome::test_addons_author_link \
tests/desktop/test_homepage.py:1:TestHome::test_that_checks_explore_side_navigation \
tests/desktop/test_homepage.py:1:TestHome::test_that_clicking_see_all_extensions_link_works \
tests/desktop/test_homepage.py:1:TestHome::test_that_checks_all_categories_side_navigation \
...
tests/desktop/test_themes.py:1:TestThemes::test_themes_breadcrumb_format \
