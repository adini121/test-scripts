...
CopyJobTest,JUnitTestPublisherTest,CredentialsTest,InternalUsersTest,ArtifactsTest,BuildHistoryTest test 2>&1 | tee $REPORTS_DIR/Core_phase2_ath_mv2_"$JenkinsVersion".log
}
